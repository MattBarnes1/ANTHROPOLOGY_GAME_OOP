...
public class Map implements Runnable {
    MapTile[][] myMap = new MapTile[10][10];
   ...
   public MapTile getMapTile(int X, int Y)
   {
    ...
    public String toString()
    {
        ...
        for(int x = 0; x < mapXAndYLength; x++)
        {
            ...
            {
                if(myMap[x][y] != null) Map.append(myMap[x][y]);
            }
            Map.append("\n");
        }
        return Map.toString();
    ...
    private void linkMapTiles(int xCoordinate, int yCoordinate) {
       ...
       if(ourTile.getNorthwest() == null) ourTile.setNorthwest(surroundingTiles[0][0]);
       if(ourTile.getNorth() == null) ourTile.setNorth(surroundingTiles[1][0]);
       if(ourTile.getNortheast() == null) ourTile.setNortheast(surroundingTiles[2][0]);
       if(ourTile.getEast() == null) ourTile.setEast(surroundingTiles[2][1]);
       if(ourTile.getSoutheast() == null) ourTile.setSoutheast(surroundingTiles[2][2]);
       if(ourTile.getSouth() == null) ourTile.setSouth(surroundingTiles[1][2]);
       if(ourTile.getSouthwest() == null) ourTile.setSouthwest(surroundingTiles[0][2]);
       if(ourTile.getWest() == null) ourTile.setWest(surroundingTiles[0][1]);
        xCoordinate++;
